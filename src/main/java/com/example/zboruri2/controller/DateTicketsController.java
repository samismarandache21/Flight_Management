...
public class DateTicketsController {
    @FXML
    ...
    public DateTicketsController(String username, ClientService clientService, TicketService ticketService,
                                 Stage stage) {
    ...
    public void initialize() {
        ...
        ticketsView.setItems(FXCollections.observableArrayList(
                ticketService.findDateTickets(Timestamp.valueOf(LocalDateTime.of(2024, 1, 24, 0, 0, 0)))
        ));
